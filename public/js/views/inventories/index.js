...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sortablejs__ = __webpack_require__(554);
...
var app = new Vue({
	...
	methods: {
		setTab: function setTab(id, key, $event) {
			// Stop default event
		...
		makeOrderedRows: function makeOrderedRows() {
	...
	mounted: function mounted() {
		...
		if ($("#inventory-list").length > 0) {
			...
			var sortable = new __WEBPACK_IMPORTED_MODULE_0_sortablejs__(el, {
