...
@section('scripts')
<script type="text/javascript" src="{{ mix('/js/views/reports/weeks.js') }}"></script>
...
<div class="container-fluid">
	...
	<bootstrap-card use-body="true" use-footer="true">
		<template slot="body">
			<h3 class="text-center">Weeks In Review</h3>
            ...
            >
                <template slot="control">
                    <select name="week" class="form-control" v-model="thisWeek" @change="setWeek">
                        <option :value="key" v-for="week, key in weeks">@{{ week }}</option>
                    </select>    
                </template>
            </bootstrap-control>
            <hr/>
