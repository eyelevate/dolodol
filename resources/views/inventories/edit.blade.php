...
<div class="container-fluid">
	{!! Form::open(['method'=>'patch','route'=>['inventory.update',$inventory->id]]) !!}

		<bootstrap-card use-header = "true" use-body="true" use-footer = "true">
			<template slot = "header"> Edit An Inventory </template>
			<template slot = "body">
	            <div class="content">
	                ...
	                <bootstrap-input class="form-group-no-border {{ $errors->has('name') ? ' has-danger' : '' }}" 
	                    ...
	                    b-name="name"
	                    b-type="text"
	                    b-value="{{ old('name') ? old('name') : $inventory->name }}"
	                ...
	                <bootstrap-textarea class="form-group-no-border {{ $errors->has('desc') ? ' has-danger' : '' }}" 
	                    ...
	                    b-name="desc"
	                    b-type="text"
	                    b-value="{{ old('desc') ? old('desc') : $inventory->desc }}"
