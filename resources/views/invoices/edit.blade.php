...
@section('scripts')
<script type="text/javascript" src="{{ mix('js/views/invoices/edit.js') }}"></script>
@endsection
...
<div id="variable-root"
	...
	suite="{{ $invoices['suite'] }}"
	city="{{ $invoices['city'] }}"
	state="{{ $invoices['state'] }}"
	country="{{ $invoices['country'] }}"
	zipcode="{{ $invoices['zipcode'] }}"
	billingStreet="{{ $invoices['billingStreet'] }}"
	billingSuite="{{ $invoices['billingSuite'] }}"
	billingCity="{{ $invoices['billingCity'] }}"
	billingState="{{ $invoices['billingState'] }}"
	billingCountry="{{ $invoices['billingCountry'] }}"
	billingZipcode="{{ $invoices['billingZipcode'] }}"
	shipping="{{ $invoices['shipping'] }}"
	expMonth="{{ $invoices['expMonth'] }}"
	expYear="{{ $invoices['expYear'] }}"
